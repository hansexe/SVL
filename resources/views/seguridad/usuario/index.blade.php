...
@section ('contenido')
  ...
  <div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		...
		<h3 class="center-block">Listado de Usuarios <a href="usuario/create"><button class="btn btn-success">Nuevo</button></a></h3>
...
<!-- el "categorias" es de CategoriaController.php en index parte de ["categorias"=> -->
